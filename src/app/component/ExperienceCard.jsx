...
export default function ExperienceCard() {
  return (
    <section
      id="exp"
      className="min-h-screen bg-white py-16 px-4 flex flex-col items-center text-gray-800"
    >
      ...
      <div className="relative w-full max-w-3xl">
        {/* Timeline line */}
        <div className="absolute left-4 top-0 h-full border-l-4 border-blue-100"></div>

        {/* Experience Card */}
        <div className="ml-10 bg-white shadow-xl rounded-2xl p-6 relative">
